...
import ubicomp.ketdiary.data.database.DatabaseDummyData;
import ubicomp.ketdiary.data.database.DatabaseRestore;
import ubicomp.ketdiary.data.database.DatabaseRestoreVer1;
...
public class PreSettingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		builder.setTitle("蝣箏��暺?");
		builder.setPositiveButton("蝣箏��", new CleanListener());
		...
		builder.setTitle("��儔鞈��?");
		builder.setPositiveButton("蝣箏��", new RestoreOnClickListener());
		builder.setNegativeButton("����", null);
		...
		builder = new AlertDialog.Builder(this);
		builder.setTitle("�KetDiary Ver1��儔鞈��?");
		builder.setPositiveButton("蝣箏��", new RestoreVer1OnClickListener());
		builder.setNegativeButton("����", null);
		...
		builder = new AlertDialog.Builder(this);
		builder.setTitle("雿輻Dummy Data?");
		builder.setMessage("雿輻敺���������");
		builder.setPositiveButton("蝣箏��", new DummyDataOnClickListener());
		builder.setNegativeButton("����", null);
